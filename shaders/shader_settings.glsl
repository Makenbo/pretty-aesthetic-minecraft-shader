...
#define MAX_SHADOW_BLUR 1 // [0 1 2 3 4 5 7 10 15 20 25 30 100] Determines how much can the shadows be blurred. Constant size blur with regular shadows, dynamic size blur with variable penumbra. Medium performance impact.
...
#define WIND
//#define FILM_GRAIN
#define LOCAL_CONTRAST .25 // [0.0 0.05 0.1 0.15 0.2 0.25 0.3 0.35 0.4 0.45 0.5 0.55 0.6 0.65 0.7 0.75 0.8 0.85 0.9 0.95 1.0]
